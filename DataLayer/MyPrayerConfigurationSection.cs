...
public class FlightJourneySearchConfigurationSection : IConfigurationSection
{
    ...
    public FlightJourneySearchConfigurationSection(ConfigurationRoot? root, string path)
    {
